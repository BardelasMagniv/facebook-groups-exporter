...
2. The popup interface will appear. Click the button to start exporting your Facebook groups.
3. The extension will fetch your groups and prompt you to download a JSON file containing the group data.
